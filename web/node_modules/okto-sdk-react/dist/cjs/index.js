...
function Loading() {
    return (React.createElement("div", { className: styles$1.loading },
        React.createElement("div", { className: styles$1.spinner }, "Loading...")));
}
...
const WidgetIframe = ({ modalData, onClose, }) => {
    ...
    return (React.createElement("div", { className: styles$2.container },
        ...
        React.createElement("iframe", { ref: iframeRef, src: widgetUrl, className: styles$2.iframe, loading: "lazy" })));
};
...
const _OktoModal = ({}, ref) => {
    ...
    return (React.createElement("div", { className: `${styles.modalOverlay} ${currentScreen ? "" : styles.hidden}`, onClick: handleClose },
        React.createElement("div", { className: styles.modalContainer },
            React.createElement("div", { className: styles.modalContent }, currentScreen === exports.ModalType.WIDGET && (React.createElement(WidgetIframe, { modalData: modalData, onClose: handleClose }))))));
};
const OktoModal = React.forwardRef(_OktoModal);

const OktoContext = React.createContext(null);
const OktoProvider = ({ children, apiKey, buildType, }) => {
